...
const ProductDetail = () => {
  ...
  return (
    <section className="py-10 lg:py-24 relative mt-16">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-16">
          ...
          <div className="pro-detail w-full flex flex-col justify-center order-last lg:order-none max-lg:max-w-[608px] max-lg:mx-auto">
            ...
            <h2 className="mb-2 font-manrope font-bold text-3xl leading-10 text-gray-900">Yellow Summer Travel Bag</h2>
          ...
          <div className="">
            <div className="mb-6">
              <img src="https://pagedone.io/asset/uploads/1700471851.png" alt="Yellow Travel Bag" className="mx-auto object-cover" />
            </div>
          </div>
        </div>
      </div>
