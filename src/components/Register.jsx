  ...
  return (
    <form className="max-w-sm mx-auto">
      ...
      <div className="flex items-start justify-center mt-5">
        <div className="flex items-center h-5">
          <p className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Already have Account? <a className="text-red-600 hover:cursor-pointer" onClick={() => setIsLogin(true)}>Login</a></p>
        </div>
      </div>
