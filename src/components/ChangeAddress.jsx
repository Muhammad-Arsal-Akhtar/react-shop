...
const ChangeAddress = ({changeAddress, setIsOpen}) => {
  ...
  return (
    <>
      <div>
        <input type="text" id="chnage_address" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          placeholder="write address here" onChange={ (e) => setModifyAddress(e.target.value) }  required /> 
      </div>
      <button onClick={() => closeAndSaveAddress()} className="text-white bg-blue-700 hover:bg-blue-800 px-5 py-2.5 rounded-lg hover:cursor-pointer">
          Save
      </button>
